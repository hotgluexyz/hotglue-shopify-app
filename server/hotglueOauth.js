...
var hmac_validator_1 = tslib_1.__importDefault(
  require("../../utils/hmac-validator")
);
var shop_validator_1 = tslib_1.__importDefault(
  require("../../utils/shop-validator")
);
var safe_compare_1 = tslib_1.__importDefault(
  require("../../utils/safe-compare")
);
var decode_session_token_1 = tslib_1.__importDefault(
  require("../../utils/decode-session-token")
);
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            context_1.Context.throwIfPrivateApp(
            ...
            session = new session_1.Session(
              isOnline ? uuid_1.v4() : this.getOfflineSessionId(shop)
            );
            session.shop = shop;
            session.state = state;
            ...
            return [
              4 /*yield*/,
              context_1.Context.SESSION_STORAGE.storeSession(session),
            ];
          case 1:
            ...
            query = {
              ...
              redirect_uri:
                "https://" + context_1.Context.HOST_NAME + redirectPath,
              state: state,
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              context_1.Context.SESSION_STORAGE.loadSession(sessionCookie),
            ];
          case 1:
          ...
          case 2:
            ...
            if (currentSession.isOnline) {
              ...
              (access_token = responseBody.access_token),
                ...
                (rest = tslib_1.__rest(responseBody, [
                  "access_token",
                  "scope",
                ]));
          ...
          case 3:
            ...
            jwtSessionId = this.getJwtSessionId(
              currentSession.shop,
              "" + onlineInfo.associated_user.id
            );
            jwtSession = session_1.Session.cloneSession(
              currentSession,
              jwtSessionId
            );
            return [
              4 /*yield*/,
              context_1.Context.SESSION_STORAGE.storeSession(jwtSession),
            ];
          case 4:
            _a.sent();
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              context_1.Context.SESSION_STORAGE.storeSession(currentSession),
            ];
          case 6:
            sessionStored = _a.sent();
            if (!sessionStored) {
